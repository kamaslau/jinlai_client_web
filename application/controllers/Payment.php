<?php
	...
	class Payment extends MY_Controller
	{
		...
		protected $names_to_sort = array(
			'Payment_id', 'user_id', 'brief', 'fullname', 'mobile', 'nation', 'province', 'city', 'county', 'street', 'longitude', 'latitude', 'zipcode', 'time_create', 'time_delete', 'time_edit', 'creator_id', 'operator_id',
		);
		...
		{	
			...
			if ($this->form_validation->run() === FALSE):
				...
				if ($result['status'] === 200):
					...
					// 检查是否需要更新本地默认地址
					if ( isset($result['content']['Payment_id']) )
						$this->session->Payment_id = $result['content']['Payment_id'];
