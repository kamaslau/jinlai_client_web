<?php
	...
	class Item_category extends MY_Controller
	{
		...
		protected $names_to_sort = array(
			'parent_id', 'nature', 'level', 'name', 'description', 'url_name', 'url_image', 'time_create', 'time_delete', 'time_edit', 'creator_id', 'operator_id',
		);
