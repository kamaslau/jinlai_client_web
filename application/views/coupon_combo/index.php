	...
	<?php else: ?>
		...
		<?php foreach ($items as $item): ?>
			...
			<li class="item col-xs-6 col-sm-4 col-md-3" data-item-id="<?php echo $item[$this->id_name] ?>">
				...
				<ul class=row>
					<li class="col-xs-6">
						<a class=create data-op-class=coupon data-op-name=create data-id="<?php echo $item[$this->id_name] ?>" title="全部领取" href="<?php echo base_url('coupon/create?combo_id='.$item[$this->id_name]) ?>" target=_blank><i class="fa fa-trash"></i> 全部领取</a>
					</li>
				</ul>
			</li>
